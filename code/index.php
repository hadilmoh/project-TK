...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=ticketsystem&table=support">
    `ticketsystem`.`support`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ticketsystem&table=groupp">
    `ticketsystem`.`groupp`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ticketsystem&table=department">
    `ticketsystem`.`department`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ticketsystem&table=users">
    `ticketsystem`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=db_aku&table=tbl_prov_kota">
    `db_aku`.`tbl_prov_kota`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=db_aku&table=tbl_prov">
    `db_aku`.`tbl_prov`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ticketsystem&table=user">
    `ticketsystem`.`user`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ticketsystem&table=groups">
    `ticketsystem`.`groups`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ticketsystem&table=grouptable">
    `ticketsystem`.`grouptable`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=test&table=first_level_category">
    `test`.`first_level_category`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.YWpheF9jcnVk" data-vpath="cm9vdA==.YWpheF9jcnVk" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=ajax_crud"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=ajax_crud" title="Structure">ajax_crud</a>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          ...
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=blog"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=blog" title="Structure">blog</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.dGVzdGluZ2Ri" data-vpath="cm9vdA==.dGVzdGluZ2Ri" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=testingdb"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=testingdb" title="Structure">testingdb</a>
  ...
  <li class="last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.dGlja2V0c3lzdGVt" data-vpath="cm9vdA==.dGlja2V0c3lzdGVt" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=ticketsystem"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=ticketsystem" title="Structure">ticketsystem</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="484f6c5a4a31384258747041495b6778">
